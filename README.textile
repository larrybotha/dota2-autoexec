...
"Download":https://github.com/larrybotha/dota2-autoexec/archive/master.zip and copy the "autoexec.cfg":https://github.com/larrybotha/dota2-autoexec/blob/master/autoexec.cfg to @Program Files (x86)\Steam\steamapps\common\dota 2 beta\config@
